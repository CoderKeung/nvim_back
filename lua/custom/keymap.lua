...
keymap("n", "Fm", '<cmd>lua require"custom.customfind".fd_nvim_dir()<CR>', {noremap = true, silent = true})
keymap("n", "Fn", "<cmd>bnext<CR>", {noremap = true, silent = true})

-- Running code Keymap
keymap("n", "Fr", '<cmd>lua require "custom.autocmd".run()<CR>', {noremap = true, silent = true})
