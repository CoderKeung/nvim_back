...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-vsnip", "cmp-buffer", "vim-vsnip", "cmp-cmdline" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-rainbow', 'gitsigns.nvim', 'Comment.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
